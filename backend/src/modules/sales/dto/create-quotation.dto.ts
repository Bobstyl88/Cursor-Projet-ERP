...
export class QuotationLineDto {
  ...
  @ApiPropertyOptional({ description: 'Tax rate percentage', example: 21, default: 0 })
  @IsOptional()
  @Type(() => Number)
  @IsNumber({ maxDecimalPlaces: 4 })
  @Min(0)
...
export class CreateQuotationDto {
  ...
  @ApiProperty({ description: 'Quotation date', example: '2026-04-09' })
  @IsDateString()
  date!: string;
  ...
  @ApiProperty({ description: 'Quotation lines', type: [QuotationLineDto] })
  @IsArray()
